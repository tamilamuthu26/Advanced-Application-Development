        ...
        <div className="container">
          ...
          <div className="columns">
            <div className="column is-2">
              <img src={image2} alt="Company 1" />
            </div>
            <div className="column is-2">
            <img src={image1} alt="Company 2" />

            </div>
            <div className="column is-2">
              <img src={image2} alt="Company 3" />
            </div>
            <div className="column is-2">
              <img src={image1} alt="Company 4" />
            </div>
            <div className="column is-2">
              <img src={image2} alt="Company 5" />
            </div>
            <div className="column is-2">
              <img src={image1} alt="Company 6" />
            </div>
          </div>
        </div>
      </section>
